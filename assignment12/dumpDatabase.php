...
<body>
<?php
$dbname = "rudejo_menagerie"; // replace with your database name
$username = "rudejo";  // replace with your username
...
echo <<< HERE
   ...
   <form action="http://puff.mnstate.edu/~gc2804kk/private/assignment12/">  <!-- change the action to where you want to go -->
